...
public partial class GameEntity {
    ...
    public Components.CooldownComponent cooldown { get { return (Components.CooldownComponent)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public void AddCooldown(float newValue) {
        ...
        var component = (Components.CooldownComponent)CreateComponent(index, typeof(Components.CooldownComponent));
